...
const Result:React.FC<ResultPageProps> = ({Size , college}) => {
  return (
    <div className="  h-fit w-full flex flex-col justify-center items-center bg-gray-300  shadow-xl">
      ...
      {/* <div className=" h-4/5 w-full container flex justify-center items-center text-6xl font-serif font-normal "> */}

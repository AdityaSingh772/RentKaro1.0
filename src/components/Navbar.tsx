...
//   return (
//     <>
//     <nav className="bg-black text-white shadow-lg shadow-black p-4 flex items-center justify-between border-y-b2-2 overflow-x-hidden    z-50 mb-3">
...
//         <Link href="/buy" className="px-4 py-2  hover:bg-white hover:text-black  rounded-full ">
//           Buy
//         </Link>
        ...
        <div className="flex font-bold text-white items-center space-x-4 mx-8">
          {user ? (
            <div>
              ...
              <Link href="/demandlist" className="mx-[0.75rem] hover:text-blue-500">
                DemandList
              </Link>
              <button className="mx-[0.75rem] hover:text-blue-500">
                <Link href="/dashboard"><FiUser className="w-6 h-6" /></Link>

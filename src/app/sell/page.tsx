...
const SellPage = () => {
  return (
    <div className="container flex flex-row justify-center h-fit w-full bg-slate-200 p-6 border-y-slate-800"> 
          <div className="container  mx-1 bg-slate-300 h-fit w-3/5 flex flex-col justify-start items-center gap-5">
                <h1 className="text-4xl font-serif font-normal my-4">Wants to be a</h1>
                <h1 className="text-7xl font-serif font-normal">Seller</h1>
      ...
      <label htmlFor="countries" className="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-500">Select your country</label>
  <select id="countries" className="bg-gray-50 mb-4 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
    ...
    <label className="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-500" htmlFor="user_avatar">Upload file</label>
...
<div className="flex items-center mb-4">
  ...
  <label htmlFor="country-option-2" className="block ms-2 text-sm font-medium text-gray-900 dark:text-gray-500">
    Buy
  </label>
</div>
  ...
  <textarea id="message"  className="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Leave a comment..."></textarea>
      ...
      >
        Submit
          ...
          <div className="  mx-1 bg-slate-300 h-fit w-2/5 flex justify-center items-center">
